...
/*
    experiment code for overlap page ratio
 */
public class ExpOverlapRatio {
    public static void main(String[] args) throws IoTDBConnectionException, StatementExecutionException {
        long startTime, endTime;
        String[] dataset = {"air", "ecg", "jinfeng", "tianyuan"};
        int[] totalSizes = {714962,700000,1095360,1002240};
        double[] overlapRatios = {0,0.2,0.4,0.6,0.8};
        int cur_overlap_index = 4;
        int cur_data_index = 3;
        int[] seq_lengths = {166,140,192,96};
        String[] ks = {"'3'","'5'","'3'","'3'"};
        ...
        double overlapRatio = overlapRatios[cur_overlap_index];
        ...
        LogWriter lw = new LogWriter("./result/ExpOverlapRatio/" + curDataset + "_res.dat");
        lw.open();
        ...
        str.append(String.valueOf(overlapRatio) + "\t");
