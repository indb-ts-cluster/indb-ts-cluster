...
/*
    experiment for different page size
 */
public class ExpPageSize {
    public static void main(String[] args) throws IoTDBConnectionException, StatementExecutionException {
        ...
        int[] PageSizes = {4096, 6144, 8192, 10240, 12288, 14336};
        int[] sizes = {700000,690000,1000000,1000000};
        int cur_page_index = 5;
        ...
        int iterNum = 10;
        int PageSize = PageSizes[cur_page_index];
        String kshapemr = "'0.2'";
        ...
        LogWriter lw = new LogWriter("./result/ExpPageSize/" + curDataset + "_res.dat");
        lw.open();
        ...
        str.append(String.valueOf(PageSize) + "\t");
